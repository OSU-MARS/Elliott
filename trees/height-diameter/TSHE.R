...
tsheDiameterFromHeightNlrob$sibbesenReplacePhysio = fit_nlrob("Sibbesen replace physio", DBH ~ (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope))*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), tshe2016physio, start = list(a1 = 2.115, a1p = -0.100, a4 = 0.00017, a5 = 0.486, b1 = 0.736, b2 = 0.0593, b2p = 0.0028))
...
tsheDiameterFromHeightGslNlsDefault$sibbesenReplacePhysio = fit_gsl_nls("Sibbesen replace physio", DBH ~ (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope))*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), tshe2016defaultWeightPhysio, start = list(a1 = 2.115, a1p = -0.100, a4 = 0.00017, a5 = 0.486, b1 = 0.736, b2 = 0.0593, b2p = 0.0028))
