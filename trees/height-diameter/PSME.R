...
if (psmeOptions$fitHeightNlrobAndFixedWeight)
{
  ...
  #psmeHeightFromDiameterNlrob$weibullBalRelHt = fit_nlrob("Weibull BA+L RelHt", TotalHt ~ 1.37 + (a1 + (a2 + a2p * isPlantation) * basalAreaLarger + a3 * standBasalAreaPerHectare + a4 * pmin(relativeHeight, 1.5)) * (1 - exp((b1 + b1p * isPlantation)*DBH^(b2 + b2p * isPlantation))), psme2016, start = list(a1 = 3.0, a2 = 0.22, a2p = 0.95, a3 = 0.12, a4 = 53, b1 = -0.06, b1p = 0.04, b2 = 0.75, b2p = 0.1)) # a3p, a4p not significant
...
if (psmeOptions$fitDbhPrimary)
{
  ...
  if (psmeOptions$fitDbhGslNlsAndGams)
  {
    ...
    psmeDiameterFromHeight$chapmanReplaceRelHt = fit_gsl_nls("Chapman-Richards replace RelHt", DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)) - 1), psme2016, start = list(a1 = 30, a1p = -10, a9 = 5, b1 = 0.12, b2 = 0.60, b2p = 0.035))
    ...
    psmeDiameterFromHeight$chapmanRichardsRelHt = fit_gsl_nls("Chapman-Richards inverse RelHt", DBH ~ (a1 + a9 * relativeHeight)*log(1 - pmin(((b1 + b1p * isPlantation)*(TotalHt - 1.37))^(b2 + b2p * isPlantation), 0.9999)), psme2016, start = list(a1 = -9.0, a9 = -12.6, b1 = 0.013, b1p = 0.009, b2 = 0.004, b2p = 0.31))
    ...
    psmeDiameterFromHeight$ruarkAbatRelHtPhysio = fit_gsl_nls("Ruark ABA+T RelHt physio", DBH ~ (a1 + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a6 * cos(3.14159/180 * aspect) + a9*relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp((b2 + b2p * isPlantation) * (TotalHt - 1.37)), psme2016physio, start = list(a1 = 2.4, a2 = -0.017, a3 = -0.004, a6 = -0.05, a9 = 0.3, b1 = 0.92, b1p = -0.19, b2 = 0.001, b2p = 0.012), significant = FALSE) # a1p, a2p, a3p, a9 not significant
    ...
    psmeDiameterFromHeight$sibbesenReplaceAbatRelHtPhysio = fit_gsl_nls("Sibbesen replace ABA+T RelHt physio", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a6 * cos(3.14159/180 * aspect) + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), psme2016physio, start = list(a1 = 3.2, a1p = -0.6, a2 = 0, a3 = 0, a6 = -0.06, a9 = 0.5, b1 = 0.60, b2 = 0.09), significant = FALSE) # a2p, a3p, a9 not significant
...
if (psmeOptions$fitDbhNlrobAndFixedWeight)
{
  ...
  psmeDiameterFromHeightNlrob$chapmanReplaceRelHt = fit_nlrob("Chapman-Richards replace RelHt", DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)) - 1), psme2016, start = list(a1 = 40, a1p = -9.2, a9 = 5.5, b1 = 0.08, b2 = 0.66, b2p = 0.019)) # a9p not significant
  ...
  psmeDiameterFromHeightNlrob$chapmanRichardsRelHt = fit_nlrob("Chapman-Richards inverse RelHt", DBH ~ (a1 + a9 * relativeHeight)*log(1 - pmin((b1*(TotalHt - 1.37))^(b2 + b2p * isPlantation), 0.9999)), psme2016, start = list(a1 = -3.4, a9 = -8.7, b1 = 0.026, b2 = 0.022, b2p = 0.14)) # a1p, b1p not significant
  ...
  psmeDiameterFromHeightNlrob$sibbesenReplaceRelHt = fit_nlrob("Sibbesen replace RelHt", DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), psme2016, start = list(a1 = 3.1, a1p = -0.5, a9 = 0.55, b1 = 0.62, b2 = 0.072))
  ...
  psmeDiameterFromHeightNlrob$weibull = fit_nlrob("Weibull inverse", DBH ~ ((a1 + a1p * isPlantation)*log(1 - pmin((b1 + b1p * isPlantation)*(TotalHt - 1.37), 0.9999)))^b2, psme2016, start = list(a1 = -360, a1p = 140, b1 = 0.01, b1p = 0.003, b2 = 0.81))
  ...
  psmeDiameterFromHeightGslNlsDefault$sibbesenReplaceAbatRelHtPhysio = fit_gsl_nls("Sibbesen replace ABA+T RelHt physio", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a6 * cos(3.14159/180 * aspect) + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), psme2016defaultWeightPhysio, start = list(a1 = 3.2, a1p = -0.49, a2 = -0.01, a3 = -0.0063, a6 = -0.05, a9 = 0, b1 = 0.63, b2 = 0.088), significant = FALSE)
  ...
  psmeDiameterFromHeightGslNlsDefault$sibbesenReplaceRelHt = fit_gsl_nls("Sibbesen replace RelHt", DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016defaultWeight, start = list(a1 = 5.0, a1p = -1.9, a9 = 0.6, b1 = 0.42, b2 = 0.13, b2p = 0.03))
  psmeDiameterFromHeightGslNlsDefault$sibbesenReplaceRelHtPhysio = fit_gsl_nls("Sibbesen replace RelHt physio", DBH ~ (a1 + a1p * isPlantation + a6 * cos(3.14159/180 * aspect) + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), psme2016defaultWeightPhysio, start = list(a1 = 3.2, a1p = -0.42, a6 = -0.06, a9 = 0.5, b1 = 0.55, b2 = 0.10))
