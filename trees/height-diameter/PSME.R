...
if (psmeOptions$fitHeightMixed)
{
  ...
  #                                            start = list(fixed = c(a1 = 320, b1 = -7.83, b2 = -0.323, b2p = 0.084)), control = nlmeControl(maxIter = 500))
  ...
  #                                                 start = list(fixed = c(Ha = 65.3, Hap = -29.3, d = 0.574, dp = 0.151, kU = 0.0118, kUp = 0.0126))) # nlminb() false convergence
  ...
  #                                                          start = list(fixed = c(a1 = 20, a4 = -0.0008, a5 = -0.04, a6 = 0.15, a7 = 0.23, a8 = 0.095, b1 = 0.30, b2 = -0.025, b3 = -0.012, b3p = -0.12, b4 = 1.6, b4p = -0.65))) # computationally singular
  ...
  #                                                      start = list(fixed = c(a1 = 60, a2 = 0.026, a2p = 0.65, a3 = 0.09, a3p = -0.07, b1 = 0.05, b2 = -0.017, b3 = 0.02, b3p = -0.05, b4 = 1.35, b4p = -0.22)), control = nlmeControl(maxIter = 500)) # job >500 iterations
...
if (psmeOptions$fitDbhPrimary)
{
  ...
  if (psmeOptions$fitDbhGslNlsAndGams)
  {
    ...
    psmeDiameterFromHeight$ruarkAbatRelHt = fit_gsl_nls("Ruark ABA+T RelHt", DBH ~ (a1 + a2 * tallerApproxBasalArea + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp((b2 + b2p * isPlantation) * (TotalHt - 1.37)), psme2016, start = list(a1 = 2.5, a2 = -0.027, a9 = 0.3, b1 = 0.91, b1p = -0.2, b2 = 0, b2p = 0.013)) # a9p not significant
    ...
    psmeDiameterFromHeight$sibbesenReplaceAbatRelHt = fit_gsl_nls("Sibbesen replace ABA+T RelHt", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016, start = list(a1 = 4.4, a1p = -1.6, a2 = -0.03, a3 = -0.006, a9 = 0.15, b1 = 0.61, b2 = 0.071, b2p = 0.021), significant = FALSE) # a9, a9p not significant
...
if (psmeOptions$fitDbhNlrobAndFixedWeight)
{
  ...
  psmeDiameterFromHeightNlrob$ruarkAbatRelHt = fit_nlrob("Ruark ABA+T RelHt", DBH ~ (a1 + a2 * tallerApproxBasalArea + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp((b2 + b2p * isPlantation) * (TotalHt - 1.37)), psme2016, start = list(a1 = 2.5, a2 = -0.026, a9 = 0.4, b1 = 0.89, b1p = -0.17, b2 = 0, b2p = 0.010))
  ...
  psmeDiameterFromHeightNlrob$sibbesenReplaceAbatRelHt = fit_nlrob("Sibbesen replace ABA+T RelHt", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016, start = list(a1 = 4.0, a1p = -1.3, a2 = -0.03, a3 = -0.005, a9 = 0.25, b1 = 0.62, b2 = 0.063, b2p = 0.013), significant = FALSE)
  ...
  psmeDiameterFromHeightGslNlsDefault$ruarkAbatRelHt = fit_gsl_nls("Ruark ABA+T RelHt", DBH ~ (a1 + a2 * tallerApproxBasalArea + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp((b2 + b2p * isPlantation) * (TotalHt - 1.37)), psme2016defaultWeight, start = list(a1 = 2.84, a2 = -0.028, a9 = 0.1, b1 = 0.87, b1p = -0.2, b2 = 0.0017, b2p = 0.014))
  ...
  psmeDiameterFromHeightGslNlsDefault$sibbesenReplaceAbatRelHt = fit_gsl_nls("Sibbesen replace ABA+T RelHt", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea + a3 * standBasalAreaApprox + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016defaultWeight, start = list(a1 = 5.8, a1p = -2.4, a2 = -0.04, a3 = -0.007, a9 = -0.1, b1 = 0.48, b2 = 0.111, b2p = 0.039), significant = FALSE) # a9, a9p not significant
...
if (psmeOptions$fitHeightPrimary & psmeOptions$fitHeightNlrobAndFixedWeight & psmeOptions$fitDbhPrimary & psmeOptions$fitDbhNlrobAndFixedWeight)
{
  ...
  psmeDiameterFromHeightPreferred$gamAbat = fit_gam("REML GAM ABA+T", DBH ~ s(TotalHt, tallerApproxBasalArea, standBasalAreaApprox, bs = "ts", by = as.factor(isPlantation), k = 28, pc = gamConstraint), data = psme2016, constraint = psme2016gamConstraint, nthreads = 2, folds = 1, repetitions = 1)
  psmeDiameterFromHeightPreferred$gamPhysio = fit_gam("REML GAM physio", DBH ~ s(TotalHt, elevation, slope, sin(3.14159/180 * aspect), cos(3.14159/180 * aspect), topographicShelterIndex, bs = "ts", by = as.factor(isPlantation), k = 85, pc = gamConstraint), data = psme2016physio, constraint = psme2016gamConstraint, nthreads = 2, folds = 1, repetitions = 1)
  psmeDiameterFromHeightPreferred$gamRelHt = fit_gam("REML GAM RelHt", DBH ~ s(TotalHt, relativeHeight, bs = "ts", by = as.factor(isPlantation), k = 13, pc = gamConstraint), data = psme2016, constraint = psme2016gamConstraint, nthreads = 2, folds = 1, repetitions = 1)
