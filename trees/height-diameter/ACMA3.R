...
if (acmaOptions$fitDbh)
{
  ...
  acmaDiameterFromHeight$chapmanReplaceRelHt = fit_gsl_nls("Chapman-Richards replace RelHt", DBH ~ (a1 + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016, start = list(a1 = 50, a9 = 0, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 1E-3), significant = FALSE) # a1-b1 evaporation, step factor from nls() and nlrob()
  ...
  #bind_rows(lapply(acmaDiameterFromHeight$sibbesenReplaceAbat$fit, get_model_coefficients))
  ...
  if (acmaOptions$fitDbhNlrob)
  {
    ...
    #acmaDiameterFromHeightNlrob$chapmanReplaceRelHt = fit_nlrob("Chapman-Richards replace RelHt", DBH ~ (a1 + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016defaultWeight, start = list(a1 = 50, a9 = -15, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 1E-3), significant = FALSE)
  ...
  acmaDiameterFromHeightGslNlsDefault = list(chapmanReplace = fit_gsl_nls("Chapman-Richards replace", DBH ~ a1*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016defaultWeight, start = list(a1 = 50, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 0.01))) # a1-b1 evaporation
  #acmaDiameterFromHeightGslNlsDefault$chapmanReplaceAbat = fit_gsl_nls("Chapman-Richards replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016defaultWeight, start = list(a1 = 50, a2 = 15, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 0.01), significant = FALSE) # a1-b1 evaporation, NaN-inf
  acmaDiameterFromHeightGslNlsDefault$chapmanReplaceRelHt = fit_gsl_nls("Chapman-Richards replace RelHt", DBH ~ (a1 + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016defaultWeight, start = list(a1 = 50, a9 = -15, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 1E-3), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$chapmanRichards = fit_gsl_nls("Chapman-Richards inverse", DBH ~ a1*log(1 - pmin(b1*(TotalHt - 1.37)^b2, 0.9999)), acma2016defaultWeight, start = list(a1 = 39, b1 = -0.022, b2 = 1.6))
  acmaDiameterFromHeightGslNlsDefault$chapmanRichardsAbat = fit_gsl_nls("Chapman-Richards inverse ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*log(1 - pmin(b1*(TotalHt - 1.37)^b2, 0.9999)), acma2016defaultWeight, start = list(a1 = 40, a2 = 0, b1 = -0.02, b2 = 1.6), control = gsl_nls_control(maxiter = 500), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$chapmanRichardsPhysio = fit_gsl_nls("Chapman-Richards inverse physio", DBH ~ (a1 + a8 * topographicShelterIndex)*log(1 - pmin(b1*(TotalHt - 1.37)^b2, 0.9999)), acma2016defaultWeight, start = list(a1 = 40, a8 = 0, b1 = -0.023, b2 = 1.6), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$chapmanRichardsRelHt = fit_gsl_nls("Chapman-Richards inverse RelHt", DBH ~ (a1 + a9 * relativeHeight)*log(1 - pmin(b1*(TotalHt - 1.37)^b2, 0.9999)), acma2016defaultWeight, start = list(a1 = 80, a9 = -30, b1 = -0.012, b2 = 1.6), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$michaelisMentenReplace = fit_gsl_nls("Michaelis-Menten replace", DBH ~ a1 * (TotalHt - 1.37)^b1 / (a2 - (TotalHt - 1.37)^b1), acma2016defaultWeight, start = list(a1 = -116, a2 = -128, b1 = 1.50))
  acmaDiameterFromHeightGslNlsDefault$naslund = fit_gsl_nls("Näslund inverse", DBH ~ (a1 + a1p * isPlantation) * sqrt(TotalHt - 1.37) / (1 + (a2 + a2p * isPlantation) * sqrt(TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 5.1, a1p = -2.0, a2 = -0.12, a2p = -0.023))
  acmaDiameterFromHeightGslNlsDefault$power = fit_gsl_nls("power", DBH ~ (a1 + a1p * isPlantation)*(TotalHt - 1.37)^(b1 + b1p * isPlantation), acma2016defaultWeight, start = list(a1 = 3.57, a1p = -2.30, b1 = 0.894, b1p = 0.282))
  #acmaDiameterFromHeightGslNlsDefault$powerAbat = fit_gsl_nls("power ABA+T", DBH ~ (a1 + a1p * isPlantation + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1 + b1p * isPlantation), acma2016defaultWeight, start = list(a1 = 3.63, a1p = -2.32, a2 = -0.00064, b1 = 0.898, b1p = 0.272))
  #acmaDiameterFromHeightGslNlsDefault$powerPhysio = fit_gsl_nls("power physio", DBH ~ (a1 + a1p * isPlantation + a5 * sin(3.14159/180 * slope) + a8 * topographicShelterIndex)*(TotalHt - 1.37)^b1, acma2016defaultWeight, start = list(a1 = 3.7, a1p = -0.9, a5 = -1.2, a8 = 0.02, b1 = 0.9))
  #acmaDiameterFromHeightGslNlsDefault$powerRelHt = fit_gsl_nls("power RelHt", DBH ~ (a1 + a9 * relativeHeight)*(TotalHt - 1.37)^b1, acma2016defaultWeight, start = list(a1 = 2.5, a9 = -0.6, b1 = 1.0), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruark = fit_gsl_nls("Ruark", DBH ~ a1*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp((b2 + b2p * isPlantation) * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.3, b1 = 1.45, b1p = -0.3, b2 = -0.033, b2p = 0.03))
  acmaDiameterFromHeightGslNlsDefault$ruarkAbat = fit_gsl_nls("Ruark ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.3, a2 = -0.01, b1 = 1.5, b1p = -0.1, b2 = -0.03), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruarkAbatPhysio = fit_gsl_nls("Ruark ABA+T physio", DBH ~ (a1 + a3 * standBasalAreaApprox + a7 * sin(3.14159/180 * aspect))*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.5, a3 = -0.007, a7 = -0.05, b1 = 1.5, b1p = -0.11, b2 = -0.03))
  acmaDiameterFromHeightGslNlsDefault$ruarkAbatPhysioRelHt = fit_gsl_nls("Ruark ABA+T RelHt physio", DBH ~ (a1 + a3 * standBasalAreaApprox + a7 * sin(3.14159/180 * aspect) + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.4, a3 = -0.007, a7 = -0.05, a9 = -0.2, b1 = 1.45, b1p = -0.1, b2 = 0.028), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruarkAbatRelHt = fit_gsl_nls("Ruark ABA+T RelHt", DBH ~ (a1 + a2 * tallerApproxBasalArea + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeightdefaultWeight, start = list(a1 = 1.3, a2 = -0.01, a9 = -0.2, b1 = 1.5, b1p = -0.09, b2 = -0.033), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruarkPhysio = fit_gsl_nls("Ruark physio", DBH ~ (a1 + a7 * sin(3.14159/180 * aspect))*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.2, a7 = -0.055, b1 = 1.45, b1p = -0.064, b2 = 0.03), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruarkRelHt = fit_gsl_nls("Ruark RelHt", DBH ~ (a1 + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeight, start = list(a1 = 1.4, a9 = 0, b1 = 1.45, b1p = -0.3, b2 = -0.03), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$ruarkRelHtPhysio = fit_gsl_nls("Ruark RelHt physio", DBH ~ (a1 + a7 * sin(3.14159/180 * aspect) + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation) * exp(b2 * (TotalHt - 1.37)), acma2016defaultWeightdefaultWeightPhysio, start = list(a1 = 1.2, a7 = -0.06, a9 = 0, b1 = 1.45, b1p = -0.07, b2 = 0.03), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$schnute = fit_gsl_nls("Schnute inverse", DBH ~ -1/a1 * log(1 - (1 - exp(-a2))*(TotalHt^b1 - 1.37^b1)/(Ha^b1 - 1.37^b1)), acma2016defaultWeight, start = list(a1 = 0.000003, a2 = 0.002, b1 = 1.13, Ha = 161))
  acmaDiameterFromHeightGslNlsDefault$sharmaParton = fit_gsl_nls("modified Sharma-Parton", DBH ~ a1*(TotalHt - 1.37)^b1*(exp(b2*(tph/topHeight)^b3*(TotalHt - 1.37)) - 1)^b4, acma2016defaultWeight, start = list(a1 = 0.6, b1 = 1.1, b2 = 0.00001, b3 = 1.2, b4 = -0.14), control = gsl_nls_control(maxiter = 500, xtol = 0.01)) # NaN-inf, b2 collapse to zero
  acmaDiameterFromHeightGslNlsDefault$sibbesenReplace = fit_gsl_nls("Sibbesen replace", DBH ~ a1*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), acma2016defaultWeight, start = list(a1 = 6, b1 = 2, b2 = -0.13))
  acmaDiameterFromHeightGslNlsDefault$sibbesenReplaceAbat = fit_gsl_nls("Sibbesen replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), acma2016defaultWeight, start = list(a1 = 0.5, a2 = 0, b1 = 2.4, b2 = -0.13), significant = FALSE)
  ...
  acmaDiameterFromHeightGslNlsDefault$sibbesenReplacePhysio = fit_gsl_nls("Sibbesen replace physio", DBH ~ (a1 + a5 * sin(3.14159/180 * slope))*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), acma2016defaultWeight, start = list(a1 = 0.5, a5 = -0.2, b1 = 2.6, b2 = -0.18, b2p = 0.02), significant = FALSE)
  acmaDiameterFromHeightGslNlsDefault$sibbesenReplaceRelHt = fit_gsl_nls("Sibbesen replace RelHt", DBH ~ (a1 + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), acma2016defaultWeight, start = list(a1 = 0.65, a9 = -0.25, b1 = 2.0, b2 = -0.1))
  ...
  acmaDiameterFromHeightGslNlsDefault$weibull = fit_gsl_nls("Weibull inverse", DBH ~ (a1*log(1 - pmin(b1*(TotalHt - 1.37), 0.9999)))^b2, acma2016defaultWeight, start = list(a1 = -40, b1 = 0.1, b2 = 0.65), control = gsl_nls_control(maxiter = 250, xtol = 1E-7))
...
if (acmaOptions$fitDbhMixed)
{
  ...
  #acmaDiameterFromHeightMixed = list(chapmanReplaceRelHt = fit_nlme("Chapman-Richards replace RelHt", DBH ~ (a1 + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, acma2016, 
  #                                                                  fixedFormula = a1 + a9 + b1 + b2 ~ 1, randomFormula = a1r ~ 1,
  #                                                                  start = list(a1 = 50, a9 = 0, b1 = 0.001, b2 = 1.0), control = gsl_nls_control(maxiter = 250, xtol = 1E-3), significant = FALSE)
