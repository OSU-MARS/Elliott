...
#psmeHeightFromDiameterChapmanRichardsBalRelHt = nls(TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + a3 * standBasalAreaPerHectare + a9 * relativeHeight) * (1 - exp(b1*DBH))^b2, psme2016, start = list(a1 = 35, a2 = 0.70, a3 = 0.055, a9 = 38.32, b1 = -0.010, b2 = 0.92), weights = pmin(DBH^-2, 1))
...
psmeHeightFromDiameterChapmanRichardsBalPhysio = nlrob(TotalHt ~ 1.37 + (a1 + (a2 + a2p * isPlantation) * basalAreaLarger + (a3 + a3p * isPlantation) * standBasalAreaPerHectare + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * topographicShelterIndex) * (1 - exp((b1 + b1p * isPlantation)*DBH))^(b2 + b2p * isPlantation), psme2016physio, start = list(a1 = 74.3, a2 = 0.096, a2p = 0.92, a3 = 0, a3p = 0, a4 = -0.015, a5 = -0.101, a6 = 0.793, a7 = 1.695, a8 = 0.183, b1 = -0.018, b1p = 0.005, b2 = 1.30, b2p = -0.154), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a4 not significant
...
psmeHeightFromDiameterChapmanRichardsPhysio = nlrob(TotalHt ~ 1.37 + (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope) + a6 * cos(3.14159/180 * aspect) + a7 * sin(3.14159/180 * aspect) + a8 * topographicShelterIndex) * (1 - exp(b1*DBH))^(b2 + b2p * isPlantation), psme2016physio, start = list(a1 = 68.5, a1p = -13.4, a4 = -0.0045, a5 = -8.09, a6 = 0.783, a7 = 0.766, a8 = 0.213, b1 = -0.022, b2 = 1.50, b2p = -0.31), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a4p not significant, a5p induces overfitting
...
psmeHeightFromDiameterGam = gam(TotalHt ~ s(DBH, by = as.factor(isPlantation)), data = psme2016)
psmeHeightFromDiameterGamBal = gam(TotalHt ~ s(DBH, standBasalAreaPerHectare, basalAreaLarger, by = as.factor(isPlantation)), data = psme2016)
#psmeHeightFromDiameterGamBalPhysio = gam(TotalHt ~ s(DBH, standBasalAreaPerHectare, basalAreaLarger, elevation, slope, sin(3.14159/180 * aspect), cos(3.14159/180 * aspect), topographicShelterIndex, by = as.factor(isPlantation)), data = psme2016physio)
#psmeHeightFromDiameterGamPhysio = gam(TotalHt ~ s(DBH, elevation, slope, sin(3.14159/180 * aspect), cos(3.14159/180 * aspect), topographicShelterIndex, by = as.factor(isPlantation)), data = psme2016physio)
...
psmeHeightFromDiameterSharmaParton = nlrob(TotalHt ~ 1.37 + a1*topHeight^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation)*DBH))^(b4 + b4p * isPlantation), psme2016, start = list(a1 = 37.66, b1 = 0.19, b1p = -0.123, b2 = -0.017, b2p = -0.026, b3 = 0.061, b3p = -0.259, b4 = 1.33, b4p = -0.22), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1))
psmeHeightFromDiameterSharmaPartonBal = nlrob(TotalHt ~ 1.37 + (a1 + a1p * isPlantation)*topHeight^(b1 + b1p * isPlantation) * (1 - exp((b2 + b2p * isPlantation)*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3*DBH))^(b4 + b4p * isPlantation), psme2016, start = list(a1 = 18.5, a1p = 11.3, b1 = 0.30, b1p = -0.14, b2 = -0.019, b2p = -0.011, b3 = 0.089, b4 = 1.49, b4p = -0.44), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # b3p not significant
psmeHeightFromDiameterSharmaPartonBalPhysio = nlrob(TotalHt ~ 1.37 + (a1 + a1p * isPlantation + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * topographicShelterIndex)*topHeight^b1 * (1 - exp((b2 + b2p * isPlantation)*(tph/(standBasalAreaPerHectare + basalAreaLarger))^(b3 + b3p * isPlantation)*DBH))^(b4 + b4p * isPlantation), psme2016physio, start = list(a1 = 52.6, a1p = -0.10, a4 = 0.00004, a5 = 0, a6 = 0.0090, a7 = 0.0032, a8 = 0.0040, b1 = 0.53, b2 = -0.025, b2p = -0.0090, b3 = 0.036, b3p = -0.19, b4 = 1.57, b4p = -0.51), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a4, a7, b1p not significant
psmeHeightFromDiameterSharmaPartonPhysio = nlrob(TotalHt ~ 1.37 + (a1 + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * topographicShelterIndex)*topHeight^b1 * (1 - exp(b2*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation)*DBH))^(b4 + b4p * isPlantation), psme2016physio, start = list(a1 = 51.9, a4 = 0.0004, a5 = 0, a6 = 0.010, a7 = 0.003, a8 = 0.004, b1 = 0.056, b2 = -0.024, b3 = -0.012, b3p = -0.23, b4 = 1.56, b4p = -0.64), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a7, b1p, b2p not significant, nlrob() step factor with a1p
psmeHeightFromDiameterSharmaZhang = nlrob(TotalHt ~ 1.37 + (a1 + a1p * isPlantation)*standBasalAreaPerHectare^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*tph^(b3 + b3p * isPlantation)*DBH))^(b4 + b4p * isPlantation), psme2016, start = list(a1 = 56.1, a1p = -23.1, b1 = 0.042, b1p = 0.117, b2 = -0.0247, b2p = -0.0131, b3 = -0.0217, b3p = -0.112, b4 = 1.476, b4p = -0.456), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # b1 not significant
psmeHeightFromDiameterSharmaZhangBal = nlrob(TotalHt ~ 1.37 + (a1 + a1p * isPlantation + (a2 + a2p * isPlantation) * basalAreaLarger)*standBasalAreaPerHectare^b1 * (1 - exp((b2 + b2p * isPlantation)*tph^(b3 + b3p * isPlantation)*DBH))^(b4 + b4p * isPlantation), psme2016, start = list(a1 = 53.5, a1p = -10.1, a2 = -0.00003, a2p = 0.012, b1 = 0.070, b2 = -0.027, b2p = -0.017, b3 = -0.064, b3p = -0.096, b4 = 1.28, b4p = -0.16), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a2, b1p, b3 not significant
...
psmeHeightFromDiameterWeibullBalRelHt = nlrob(TotalHt ~ 1.37 + (a1 + (a2 + a2p * isPlantation) * basalAreaLarger + a3 * standBasalAreaPerHectare + a4 * pmin(relativeHeight, 1.25)) * (1 - exp((b1 + b1p * isPlantation)*DBH^(b2 + b2p * isPlantation))), psme2016, start = list(a1 = 35.2, a2 = 0.10, a2p = 2.05, a3 = -0.035, a4 = 41.9, b1 = -0.013, b1p = 0.007, b2 = 0.94, b2p = -0.096), weights = pmin(DBH^if_else(isPlantation, -1.2, -0.4), 1)) # a3p, a4p not significant
#confint_nlrob(psmeHeightFromDiameterSharmaPartonBalPhysio, level = 0.99, weights = pmin(psme2016physio$DBH^if_else(psme2016physio$isPlantation, -1.2, -0.4), 1))
...
psmeHeightFromDiameterChapmanRichardsBal = get_height_error("Chapman-Richards BA+L", psmeHeightFromDiameterChapmanRichardsBal, psme2016, psme2016natural, psme2016plantation)
psmeHeightFromDiameterChapmanRichardsBalPhysio = get_height_error("Chapman-Richards BA+L physio", psmeHeightFromDiameterChapmanRichardsBalPhysio, psme2016physio, psme2016natural, psme2016plantationPhysio)
psmeHeightFromDiameterChapmanRichardsBalRelHt = get_height_error("Chapman-Richards BA+L RelHt", psmeHeightFromDiameterChapmanRichardsBalRelHt, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterGam = get_height_error("GCV GAM", psmeHeightFromDiameterGam, psme2016, psme2016natural, psme2016plantation)
psmeHeightFromDiameterGamBal = get_height_error("GCV GAM BA+L", psmeHeightFromDiameterGamBal, psme2016, psme2016natural, psme2016plantation)
#psmeHeightFromDiameterGamBalPhysio = get_height_error("GCV GAM BA+L physio", psmeHeightFromDiameterGamBalPhysio, psme2016physio, psme2016natural, psme2016plantation) # slow
#psmeHeightFromDiameterGamPhysio = get_height_error("GCV GAM physio", psmeHeightFromDiameterGamPhysio, psme2016physio, psme2016natural, psme2016plantation)
#save(psmeHeightFromDiameterGamBalPhysio, psmeHeightFromDiameterGamPhysio, file = "trees/height-diameter/HtDia PSME spline height.rdata")
...
psmeHeightFromDiameterSharmaPartonBal = get_height_error("Sharma-Parton BA+L", psmeHeightFromDiameterSharmaPartonBal, psme2016, psme2016natural, psme2016plantation)
psmeHeightFromDiameterSharmaPartonBalPhysio = get_height_error("Sharma-Parton BA+L physio", psmeHeightFromDiameterSharmaPartonBalPhysio, psme2016physio, psme2016natural, psme2016plantationPhysio)
...
psmeHeightFromDiameterSharmaZhangBal = get_height_error("Sharma-Zhang BA+L", psmeHeightFromDiameterSharmaZhangBal, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterWeibullBal = get_height_error("Weibull BA+L", psmeHeightFromDiameterWeibullBal, psme2016, psme2016natural, psme2016plantation)
psmeHeightFromDiameterWeibullBalRelHt = get_height_error("Weibull BA+L RelHt", psmeHeightFromDiameterWeibullBalRelHt, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterResults = bind_rows(as_row(psmeHeightFromDiameterChapmanRichards),
                                          ...
                                          as_row(psmeHeightFromDiameterGam),
                                          as_row(psmeHeightFromDiameterGamBal),
                                          as_row(psmeHeightFromDiameterGamBalPhysio),
                                          as_row(psmeHeightFromDiameterGamPhysio),
...
psmeHeightFromDiameterChapmanRichardsBalGnls = get_height_error("Chapman-Richards BA+L GNLS", psmeHeightFromDiameterChapmanRichardsBalGnls, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterSharmaPartonBalGnls = get_height_error("Sharma-Parton BA+L GNLS", psmeHeightFromDiameterSharmaPartonBalGnls, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterSharmaZhangBalGnls = get_height_error("Sharma-Zhang BA+L GNLS", psmeHeightFromDiameterSharmaZhangBalGnls, psme2016, psme2016natural, psme2016plantation)
...
psmeHeightFromDiameterWeibullBalGnls = get_height_error("Weibull BA+L GNLS", psmeHeightFromDiameterWeibullBalGnls, psme2016, psme2016natural, psme2016plantation)
...
ggplot() +
  ...
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterChapmanRichardsBal$fitted.values, color = "Chapman-Richards BA+L", group = psme2016$isPlantation), alpha = 0.5) +
  ...
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterSharmaParton$fitted.values, color = "Sharma-Parton", group = psme2016$isPlantation), alpha = 0.5) +
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterSharmaPartonBal$fitted.values, color = "Sharma-Parton BA+L", group = psme2016$isPlantation), alpha = 0.5) +
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterSharmaZhang$fitted.values, color = "Sharma-Zhang", group = psme2016$isPlantation), alpha = 0.5) +
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterSharmaZhangBal$fitted.values, color = "Sharma-Zhang BA+L", group = psme2016$isPlantation), alpha = 0.5) +
  #geom_line(aes(x = psme2016$DBH, y = psmeHeightFromDiameterWeibullBal$fitted.values, color = "Weibull BA+L", group = psme2016$isPlantation), alpha = 0.5) +
...
psmeDiameterFromHeightChapmanFormBalRelHt = nlrob(DBH ~ (a1 + a1p * isPlantation + a2 * basalAreaLarger + (a9 + a9p * isPlantation) * relativeHeight) * (exp((b1 + b1p * isPlantation)*(TotalHt - 1.37)) - 1)^(b2 + b2p * isPlantation), psme2016, start = list(a1 = 139, a1p = -38.5, a2 = -1.2, a9 = -5.5, a9p = 0.22, b1 = 0.012, b1p = 0.003, b2 = 0.796, b2p = 0.066), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5), control = nls.control(maxiter = 500)) # a2p not significant, nlrob() step factor with a9 * BA
psmeDiameterFromHeightChapmanFormRelHt = nlrob(DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(exp(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)) - 1), psme2016, start = list(a1 = 21.1, a1p = -6.56, a9 = 0.278, b1 = 0.170, b2 = 0.580, b2p = 0.0395), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5)) # a4p not significant
...
psmeDiameterFromHeightChapmanRichardsPhysio = nlrob(DBH ~ (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope) + a6 * cos(3.14159/180 * aspect) + a7 * sin(3.14159/180 * aspect) + a8 * topographicShelterIndex)*log(1 - pmin(((b1 + b1p * isPlantation)*(TotalHt - 1.37))^b2, 0.9999)), psme2016physio, start = list(a1 = -17.9, a1p = -0133, a4 = 0.0024, a5 = -7.189, a6 = 0.359, a7 = 0.170, a8 = 0.180, b1 = 0.0176, b1p = 0.0058, b2 = 0.404), maxit = 20, weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5), control = nls.control(maxiter = 50)) # a7 not significant
psmeDiameterFromHeightChapmanRichardsRelHt = nlrob(DBH ~ (a1 + a9 * relativeHeight)*log(1 - pmin(((b1 + b1p * isPlantation)*(TotalHt - 1.37))^(b2 + b2p * isPlantation), 0.9999)), psme2016, start = list(a1 = -1.22, a9 = -3.11, b1 = 0.018, b1p = 0.006, b2 = 0.003, b2p = 0.052), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5), maxit = 20) # a1p not significant
psmeDiameterFromHeightGam = gam(DBH ~ s(TotalHt, by = as.factor(isPlantation)), data = psme2016)
psmeDiameterFromHeightGamAat = gam(DBH ~ s(TotalHt, tallerQuasiBasalArea, standQuasiBasalArea, by = as.factor(isPlantation)), data = psme2016)
#psmeDiameterFromHeightGamAatPhysio = gam(DBH ~ s(TotalHt, tallerQuasiBasalArea, standQuasiBasalArea, elevation, slope, sin(3.14159/180 * aspect), cos(3.14159/180 * aspect), topographicShelterIndex, by = as.factor(isPlantation)), data = psme2016physio) # warnings
#psmeDiameterFromHeightGamPhysio = gam(DBH ~ s(TotalHt, elevation, slope, sin(3.14159/180 * aspect), cos(3.14159/180 * aspect), topographicShelterIndex, by = as.factor(isPlantation)), data = psme2016physio)
...
psmeDiameterFromHeightPowerPhysio = nlrob(DBH ~ (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope) + a6 * cos(3.14159/180 * aspect) + a7 * sin(3.14159/180 * aspect) + a8 * topographicShelterIndex)*(TotalHt - 1.37)^(b1 + b1p * isPlantation), psme2016physio, start = list(a1 = 1.630, a1p = 0.284, a4 = 0.00001, a5 = -0.082, a6 = -0.019, a7 = 0.0028, a8 = -0.0018, b1 = 1.03, b1p = -0.102), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5)) # a7 not significant
psmeDiameterFromHeightPowerRelHt = nlrob(DBH ~ (a1 + a9 * relativeHeight)*(TotalHt - 1.37)^(b1 + b1p * isPlantation), psme2016, start = list(a1 = 1.95, a9 = 0.361, b1 = 0.943, b1p = -0.068), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5)) # a1p, a4p not significant
...
psmeDiameterFromHeightSharmaParton = nlrob(DBH ~ a1*(TotalHt - 1.37)^(b1 + b1p * isPlantation)*(exp(b2*(tph/topHeight)^(b3 + b3p * isPlantation)*(TotalHt - 1.37)) - 1)^(b4 + b4p * isPlantation), psme2016, start = list(a1 = 3.95, b1 = 0.681, b1p = -0.139, b2 = 0.097, b3 = -0.130, b3p = 0.157, b4 = 0.125, b4p = 0.0678), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5), control = list(maxiter = 200)) # a1p NaN-inf (not significant?), singular gradient with all relative height forms attempted
...
psmeDiameterFromHeightSibbesenFormPhysio = nlrob(DBH ~ (a1 + a1p * isPlantation + a4 * elevation + a5 * sin(3.14159/180 * slope) + a6 * cos(3.14159/180 * aspect) + a7 * sin(3.14159/180 * aspect) + a8 * topographicShelterIndex)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016physio, start = list(a1 = 3.812, a1p = -0.925, a4 = 0.00022, a5 = 0.0663, a6 = -0.0495, a7 = -0.0151, a8 = -0.00630, b1 = 0.520, b2 = 0.111, b2p = 0.0173), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5)) # a5, a7 not significant
psmeDiameterFromHeightSibbesenFormRelHt = nlrob(DBH ~ (a1 + a1p * isPlantation + a9 * relativeHeight)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), psme2016, start = list(a1 = 3.90, a1p = -0.95, a9 = 0.085, b1 = 0.520, b2 = 0.109, b2p = 0.016), weights = pmin(TotalHt^if_else(isPlantation, -1.6, -1.7), 0.5)) # a4p not significant
...
#confint_nlrob(psmeDiameterFromHeightSibbesenFormRelHt, level = 0.99, weights = pmin(psme2016$TotalHt^if_else(psme2016$isPlantation, -1.6, -1.7), 0.5))
...
psmeDiameterFromHeightChapmanFormAat = get_dbh_error("Chapman-Richards form AA+T", psmeDiameterFromHeightChapmanFormAat, psme2016, psme2016natural, psme2016plantation)
psmeDiameterFromHeightChapmanFormBal = get_dbh_error("Chapman-Richards form BA+L", psmeDiameterFromHeightChapmanFormBal, psme2016, psme2016natural, psme2016plantation)
psmeDiameterFromHeightChapmanFormBalRelHt = get_dbh_error("Chapman-Richards form BA+L RelHt", psmeDiameterFromHeightChapmanFormBalRelHt, psme2016, psme2016natural, psme2016plantation)
...
psmeDiameterFromHeightChapmanRichardsAat = get_dbh_error("Chapman-Richards AA+T", psmeDiameterFromHeightChapmanRichardsAat, psme2016, psme2016natural, psme2016plantation)
...
psmeDiameterFromHeightGam = get_dbh_error("GCV GAM", psmeDiameterFromHeightGam, psme2016, psme2016natural, psme2016plantation)
psmeDiameterFromHeightGamAat = get_dbh_error("GCV GAM AA+T", psmeDiameterFromHeightGamAat, psme2016, psme2016natural, psme2016plantation)
#psmeDiameterFromHeightGamAatPhysio = get_dbh_error("GCV GAM AA+T physio", psmeDiameterFromHeightGamAatPhysio, psme2016physio, psme2016natural, psme2016plantation)
#psmeDiameterFromHeightGamPhysio = get_dbh_error("GCV GAM physio", psmeDiameterFromHeightGamPhysio, psme2016physio, psme2016natural, psme2016plantation)
#save(psmeDiameterFromHeightGamAatPhysio, psmeDiameterFromHeightGamPhysio, file = "trees/height-diameter/HtDia PSME spline DBH.rdata")
...
psmeDiameterFromHeightPowerAat = get_dbh_error("power AA+T", psmeDiameterFromHeightPowerAat, psme2016, psme2016natural, psme2016plantation)
...
psmeDiameterFromHeightSibbesenFormAat = get_dbh_error("Sibbesen form AA+T", psmeDiameterFromHeightSibbesenFormAat, psme2016, psme2016natural, psme2016plantation)
...
psmeDiameterFromHeightResults = bind_rows(as_row(psmeDiameterFromHeightChapmanRichards),
                                          ...
                                          as_row(psmeDiameterFromHeightGam),
                                          as_row(psmeDiameterFromHeightGamAat),
                                          as_row(psmeDiameterFromHeightGamAatPhysio),
                                          as_row(psmeDiameterFromHeightGamPhysio),
...
ggplot(psme2016) +
  ...
  #geom_line(aes(x = psmeDiameterFromHeightChapmanFormAat$fitted.values, y = TotalHt, color = "Chapman form AA+T", group = isPlantation), alpha = 0.5) +
  #geom_line(aes(x = psmeDiameterFromHeightChapmanFormBal$fitted.values, y = TotalHt, color = "Chapman form BA+L", group = isPlantation), alpha = 0.5) +
  ...
  #geom_line(aes(x = (1.75 + 0.000001 * tallerQuasiBasalArea + -0.000001 * standQuasiBasalArea) * exp(1.46*(TotalHt - 1.37)^0.280), y = TotalHt, color = "Chapman form BA+L", group = isPlantation), alpha = 0.5) +
...
psmeParameters = bind_rows(bind_rows(get_coefficients(psmeHeightFromDiameterChapmanRichards),
                                     ...
                                     get_coefficients(psmeHeightFromDiameterGam),
                                     get_coefficients(psmeHeightFromDiameterGamBal),
                                     get_coefficients(psmeHeightFromDiameterGamBalPhysio),
                                     get_coefficients(psmeHeightFromDiameterGamPhysio),
                           ...
                           bind_rows(get_coefficients(psmeDiameterFromHeightChapmanRichards),
                                     ...
                                     get_coefficients(psmeDiameterFromHeightGam),
                                     get_coefficients(psmeDiameterFromHeightGamAat),
                                     get_coefficients(psmeDiameterFromHeightGamAatPhysio),
                                     get_coefficients(psmeDiameterFromHeightGamPhysio),
