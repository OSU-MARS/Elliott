...
umcaDiameterFromHeightNlrob$ruarkAbat = fit_nlrob("Ruark ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^b1 * exp(b2 * (TotalHt - 1.37)), umca2016, start = list(a1 = 4.0, a2 = 0, b1 = 0.43, b2 = 0.06), control = nls.control(maxiter = 100, tol = 1E-4), significant = FALSE) # job step factor
umcaDiameterFromHeightNlrob$ruarkPhysio = fit_nlrob("Ruark physio", DBH ~ (a1 + a5 * sin(3.14159/180 * slope))*(TotalHt - 1.37)^b1 * exp(b2 * (TotalHt - 1.37)), umca2016physio, start = list(a1 = 6, a5 = 0, b1 = 0.6, b2 = 0.04), control = nls.control(maxiter = 100, tol = 1E-4), significant = FALSE) # job step factor
...
umcaDiameterFromHeightNlrob$ruarkRelHtPhysio = fit_nlrob("Ruark RelHt physio", DBH ~ (a1 + a5 * sin(3.14159/180 * slope) + a9 * relativeHeight)*(TotalHt - 1.37)^b1 * exp(b2 * (TotalHt - 1.37)), umca2016physio, start = list(a1 = 4.5, a5 = 0, a9 = -3, b1 = 0.45, b2 = 0.08), control = nls.control(maxiter = 100, tol = 1E-4), significant = FALSE) # job step factor
...
umcaDiameterFromHeightNlrob$sibbesenReplaceAbat = fit_nlrob("Sibbesen replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), umca2016, start = list(a1 = 3.8, a2 = 0, b1 = 0.46, b2 = 0.21), control = nls.control(maxiter = 100, tol = 1E-4), significant = FALSE) # occasional step factor
