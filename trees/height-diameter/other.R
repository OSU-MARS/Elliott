...
otherHeightFromDiameter$chapmanRichardsBal = fit_gsl_nls("Chapman-Richards BA+L", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + a3 * standBasalAreaPerHectare) * (1 - exp(b1*DBH))^b2, other2016, start = list(a1 = 45, a2 = 1.0, a3 = -0.5, b1 = -0.01, b2 = 0.9)) # a1-b1 evaporation, a1p, a2p, a2, a3p, a3, b1p, b2p not significant, semi-regular NaN-inf with nlrob()
...
otherHeightFromDiameter$chapmanRichardsBalRelHt = fit_gsl_nls("Chapman-Richards BA+L RelHt", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + (a3 + a3p * isPlantation) * standBasalAreaPerHectare + (a4 + a4p * isPlantation) * relativeHeight) * (1 - exp(b1*DBH))^b2, other2016, start = list(a1 = -1.16, a2 = -0.05, a3 = 0.07, a3p = 0.09, a4 = 16.6, a4p = -6.7, b1 = -0.05, b2 = 0.28)) # a2, a2p, a3, b1, b1p, b2p not significant
...
otherHeightFromDiameter$sharmaPartonBal = fit_gsl_nls("Sharma-Parton BA+L", TotalHt ~ 1.37 + a1*topHeight^b1 * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3*DBH))^b4, other2016, start = list(a1 = 200, b1 = -0.15, b2 = -0.003, b3 = -0.33, b4 = 0.77), control = gsl_nls_control(maxiter = 250, xtol = 1E-5)) # a1p, b1p, b2p, b3p, b4p not significant, potential a1-b1 evaporation, intermittent NaN-infs with nlrob()
...
otherHeightFromDiameter$weibullBalRelHt = fit_gsl_nls("Weibull BA+L RelHt", TotalHt ~ 1.37 + (a1 + a3 * standBasalAreaPerHectare + a4 * pmin(relativeHeight, 1.25)) * (1 - exp(b1*DBH^b2)), other2016, start = list(a1 = -1.1, a3 = 0.3, a4 = 50, b1 = -0.1, b2 = 0.6), control = gsl_nls_control(maxiter = 250)) # a2, a3, a3p, a4p, b2p not significant, a4 debatable
...
otherHeightFromDiameterNlrob$chapmanRichardsBalRelHt = fit_nlrob("Chapman-Richards BA+L RelHt", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + (a3 + a3p * isPlantation) * standBasalAreaPerHectare + (a4 + a4p * isPlantation) * relativeHeight) * (1 - exp(b1*DBH))^b2, other2016, start = list(a1 = -1.16, a2 = -0.05, a3 = 0.07, a3p = 0.09, a4 = 16.6, a4p = -6.7, b1 = -0.05, b2 = 0.28))
...
get_list_coefficients(otherHeightFromDiameterNlrob$korf)
...
otherHeightFromDiameterNlrob$weibullBalRelHt = fit_nlrob("Weibull BA+L RelHt", TotalHt ~ 1.37 + (a1 + a3 * standBasalAreaPerHectare + a4 * pmin(relativeHeight, 1.25)) * (1 - exp(b1*DBH^b2)), other2016, start = list(a1 = -1.1, a3 = 0.3, a4 = 50, b1 = -0.1, b2 = 0.6), maxit = 80, control = nls.control(maxiter = 250))
...
otherHeightFromDiameterGslNlsDefault$chapmanRichardsBal = fit_gsl_nls("Chapman-Richards BA+L", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + a3 * standBasalAreaPerHectare) * (1 - exp(b1*DBH))^b2, other2016defaultWeight, start = list(a1 = 45, a2 = 1.0, a3 = -0.5, b1 = -0.01, b2 = 0.9))
otherHeightFromDiameterGslNlsDefault$chapmanRichardsBalPhysio = fit_gsl_nls("Chapman-Richards BA+L physio", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + a4 * elevation) * (1 - exp(b1*DBH))^b2, other2016defaultWeightPhysio, start = list(a1 = 80, a2 = 0.3, a4 = 0.005, b1 = -0.005, b2 = 0.8), significant = FALSE)
otherHeightFromDiameterGslNlsDefault$chapmanRichardsBalRelHt = fit_gsl_nls("Chapman-Richards BA+L RelHt", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger + (a3 + a3p * isPlantation) * standBasalAreaPerHectare + (a4 + a4p * isPlantation) * relativeHeight) * (1 - exp(b1*DBH))^b2, other2016defaultWeight, start = list(a1 = -1.16, a2 = -0.05, a3 = 0.07, a3p = 0.09, a4 = 16.6, a4p = -6.7, b1 = -0.05, b2 = 0.28))
...
otherHeightFromDiameterGslNlsDefault$sharmaPartonBal = fit_gsl_nls("Sharma-Parton BA+L", TotalHt ~ 1.37 + a1*topHeight^b1 * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3*DBH))^b4, other2016defaultWeight, start = list(a1 = 200, b1 = -0.15, b2 = -0.003, b3 = -0.33, b4 = 0.77), control = gsl_nls_control(maxiter = 250, xtol = 1E-5))
otherHeightFromDiameterGslNlsDefault$sharmaPartonBalPhysio = fit_gsl_nls("Sharma-Parton BA+L physio", TotalHt ~ 1.37 + (a1 + a4 * elevation)*topHeight^b1 * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3*DBH))^b4, other2016defaultWeightPhysio, start = list(a1 = 300, a4 = 0.0, b1 = -0.2, b2 = -0.003, b3 = -0.34, b4 = 0.76), control = gsl_nls_control(maxiter = 500, xtol = 1E-5), significant = FALSE)
...
otherHeightFromDiameterGslNlsDefault$weibullBal = fit_gsl_nls("Weibull BA+L", TotalHt ~ 1.37 + (a1 + a2 * basalAreaLarger) * (1 - exp(b1*DBH^b2)), other2016defaultWeight, start = list(a1 = 100, a2 = 0.6, b1 = -0.01, b2 = 0.8), significant = FALSE)
otherHeightFromDiameterGslNlsDefault$weibullBalRelHt = fit_gsl_nls("Weibull BA+L RelHt", TotalHt ~ 1.37 + (a1 + a3 * standBasalAreaPerHectare + a4 * pmin(relativeHeight, 1.25)) * (1 - exp(b1*DBH^b2)), other2016defaultWeight, start = list(a1 = -1.1, a3 = 0.3, a4 = 50, b1 = -0.1, b2 = 0.6), control = gsl_nls_control(maxiter = 250))
...
otherDiameterFromHeight$chapmanReplaceAbat = fit_gsl_nls("Chapman-Richards replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(exp(b1*(TotalHt - 1.37)) - 1)^b2, other2016, start = list(a1 = 10, a2 = 0.03, b1 = 0.10, b2 = 0.5)) # occasional step factor with nlrob()
...
otherDiameterFromHeight$chapmanReplaceBalRelHt = fit_gsl_nls("Chapman-Richards replace BA+L RelHt", DBH ~ (a1 + a2 * basalAreaLarger + a3 * standBasalAreaPerHectare + a9 * relativeHeight) * (exp(b1*(TotalHt - 1.37)^b2) - 1), other2016, start = list(a1 = 0.5, a2 = -0.02, a3 = 0.03, a9 = 0.2, b1 = 2, b2 = 0.2), significant = FALSE) # step factor with nls(), step factor or singular gradient with nlrob()
...
otherDiameterFromHeight$ruarkAbat = fit_gsl_nls("Ruark ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^b1 * exp(b2 * (TotalHt - 1.37)), other2016, start = list(a1 = 2.6, a2 = 0.015, b1 = 0.5, b2 = 0.04), significant = FALSE) # a2, a3, a2p, a3p, b1p, b2p not significant
...
otherDiameterFromHeight$sibbesenReplaceAbat = fit_gsl_nls("Sibbesen replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), other2016, start = list(a1 = 2.7, a2 = 0.01, b1 = 0.28, b2 = 0.34), significant = FALSE) # a1p, a2, a3, b1p, b2p not significant
otherDiameterFromHeight$sibbesenReplacePhysio = fit_gsl_nls("Sibbesen replace physio", DBH ~ (a1 + a1p * isPlantation + a8 * topographicShelterIndex)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), other2016physio, start = list(a1 = 3.5, a1p = -0.4, a8 = -0.01, b1 = 0.3, b2 = 0.33, b2p = 0.02), significant = FALSE) # b1p, no physiographic predictor significant, b2p debatable
...
otherDiameterFromHeightNlrob$ruarkAbat = fit_nlrob("Ruark ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^b1 * exp(b2 * (TotalHt - 1.37)), other2016, start = list(a1 = 2.6, a2 = 0.015, b1 = 0.5, b2 = 0.04), significant = FALSE)
...
otherDiameterFromHeightNlrob$sibbesenReplaceAbat = fit_nlrob("Sibbesen replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), other2016, start = list(a1 = 2.7, a2 = 0.01, b1 = 0.28, b2 = 0.34), control = nls.control(tol = 1E-3), significant = FALSE)
otherDiameterFromHeightNlrob$sibbesenReplacePhysio = fit_nlrob("Sibbesen replace physio", DBH ~ (a1 + a1p * isPlantation + a8 * topographicShelterIndex)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), other2016physio, start = list(a1 = 3.5, a1p = -0.4, a8 = -0.01, b1 = 0.3, b2 = 0.33, b2p = 0.02), significant = FALSE)
...
otherDiameterFromHeightGslNlsDefault$chapmanReplaceBal = fit_gsl_nls("Chapman-Richards replace BA+L", DBH ~ (a1 + a3 * standBasalAreaPerHectare) * (exp(b1*(TotalHt - 1.37)^b2) - 1), other2016defaultWeight, start = list(a1 = 1.0, a3 = 0.003, b1 = 1.25, b2 = 0.33), control = gsl_nls_control(maxiter = 250, xtol = 1E-5), significant = FALSE) # a1-b1 evaporation
otherDiameterFromHeightGslNlsDefault$chapmanReplaceBalRelHt = fit_gsl_nls("Chapman-Richards replace BA+L RelHt", DBH ~ (a1 + a2 * basalAreaLarger + a3 * standBasalAreaPerHectare + a9 * relativeHeight) * (exp(b1*(TotalHt - 1.37)^b2) - 1), other2016defaultWeight, start = list(a1 = 0.5, a2 = -0.02, a3 = 0.03, a9 = 0.2, b1 = 2, b2 = 0.2), control = gsl_nls_control(maxiter = 250, xtol = 0.01), significant = FALSE) # a1-b1 evaporation
...
otherDiameterFromHeightGslNlsDefault$sibbesenReplaceAbat = fit_gsl_nls("Sibbesen replace ABA+T", DBH ~ (a1 + a2 * tallerApproxBasalArea)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^b2), other2016defaultWeight, start = list(a1 = 2.7, a2 = 0.01, b1 = 0.28, b2 = 0.34), significant = FALSE)
otherDiameterFromHeightGslNlsDefault$sibbesenReplacePhysio = fit_gsl_nls("Sibbesen replace physio", DBH ~ (a1 + a1p * isPlantation + a8 * topographicShelterIndex)*(TotalHt - 1.37)^(b1*(TotalHt - 1.37)^(b2 + b2p * isPlantation)), other2016defaultWeightPhysio, start = list(a1 = 3.5, a1p = -0.4, a8 = -0.01, b1 = 0.3, b2 = 0.33, b2p = 0.02), significant = FALSE)
